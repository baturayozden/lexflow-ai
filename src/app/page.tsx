    ...
    <main className="min-h-screen" style={{ background: '#0D1117' }}>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <p className="text-center text-[#64748B] text-xs uppercase tracking-widest mb-8">Trusted by firms across England &amp; Wales</p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-2 bg-[#161F2E] border rounded-full px-5 py-2.5"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <motion.div
                ...
                whileHover={reduced ? {} : { y: -4, borderColor: 'rgba(212,168,67,0.35)' }}
                className="rounded-2xl p-7 border transition-colors cursor-default"
                style={{ background: '#161F2E', borderColor: 'rgba(255,255,255,0.08)' }}
              >
          ...
          >
            <p className="text-[#94A3B8] text-base">
              That is{' '}
              <strong className="text-white">18–28 billable hours per week</strong> your firm is giving away.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {[
              ...
              },
              {
                ...
                tagColor: 'text-[#D4A843] bg-[#D4A843]/10 border-[#D4A843]/20',
              },
              {
                big: false,
                icon: '📋',
                title: 'Gov.uk Checklist Automation',
              ...
              <motion.div
                ...
                whileHover={reduced ? {} : { borderColor: 'rgba(212,168,67,0.3)', boxShadow: '0 0 30px rgba(212,168,67,0.07)' }}
                className={`rounded-2xl p-7 border transition-all cursor-default ${card.big ? 'md:col-span-1' : ''}`}
                style={{ background: '#161F2E', borderColor: 'rgba(255,255,255,0.08)' }}
              >
      ...
      <section id="how-it-works" className="py-28 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative grid md:grid-cols-3 gap-8 md:gap-0">
            ...
            <div className="hidden md:block absolute top-10 left-1/6 right-1/6 h-px" style={{ background: 'linear-gradient(90deg,transparent,rgba(212,168,67,0.3),transparent)' }} />
            ...
            {[
              ...
              >
                ...
                <span className="text-xs text-[#D4A843] font-medium px-3 py-1 rounded-full" style={{ background: 'rgba(212,168,67,0.08)' }}>
                  {item.tag}
                </span>
              </motion.div>
            ))}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="overflow-x-auto mt-12">
            <table className="w-full min-w-[600px]">
              <thead>
                <tr>
                  <th className="text-left py-3 px-4 text-[#64748B] text-sm font-medium w-44">Feature</th>
                  {['LexFlow', 'Clio', 'LEAP', 'Smokeball'].map((col, i) => (
                    <th key={col} className={`py-3 px-4 text-sm font-semibold text-center ${i === 0 ? 'text-[#D4A843]' : 'text-[#64748B]'}`}>
                      {i === 0 ? (
              ...
              <tbody>
                {comparisonRows.map((row, i) => (
                  ...
                  >
                    <td className="py-4 px-4 text-[#94A3B8] text-sm">{row.feature}</td>
                    {[row.lexflow, row.clio, row.leap, row.smokeball].map((cell, j) => (
                      <td key={j} className={`py-4 px-4 text-sm text-center ${j === 0 ? 'bg-[#D4A843]/5 border-x border-[#D4A843]/15 font-medium' : ''}`}>
                        <span className={
                          ...
                          cell === '❌' ? 'text-[#64748B] text-base' :
                          cell.startsWith('⚠️') ? 'text-yellow-400 text-sm' :
                          j === 0 ? 'text-[#D4A843]' : 'text-[#94A3B8]'
                        }>
                          {cell}
                        </span>
                      </td>
      ...
      <section id="pricing" className="py-28 px-6">
        <div className="max-w-5xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-16">
            ...
            <p className="text-[#94A3B8]">No hidden fees. No complicated contracts. No per-user charges.</p>
          </motion.div>
          ...
          <p className="text-center text-[#64748B] text-sm mt-6">All prices exclude VAT. No hidden fees. No per-user charges.</p>
        </div>
      </section>
            ...
            {[
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[#64748B] text-xs mt-0.5">{t.firm}</div>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section id="faq" className="py-28 px-6">
        <div className="max-w-2xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-12">
            ...
            <p className="text-[#94A3B8]">Everything you need to know before getting started.</p>
          </motion.div>
      ...
      ════════════════════════════════════════════════════════════════ */}
      <section id="contact" className="py-28 px-6 relative" style={{ position: 'relative', zIndex: 10 }}>
        <div className="absolute inset-0 pointer-events-none" aria-hidden>
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-64 bg-[#D4A843]/5 rounded-full blur-3xl" />
        </div>
